...
MIN_SPREAD = 2.0  # 🎯 МІНІМАЛЬНИЙ СПРЕД: 2.0% для автоторгівлі (як просив користувач)
MAX_SPREAD = 3.0  # 🎯 МАКСИМАЛЬНИЙ СПРЕД: 3.0% для автоторгівлі (як просив користувач)
MIN_NET_PROFIT_PERCENT = 1.4  # 🎯 Чистий прибуток після витрат: 2.0% спред - 0.6% витрати = 1.4%
